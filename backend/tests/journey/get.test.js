...
describe('GET /api/journey/', () => {
    ...
    beforeEach(async () => {
        ...
        j1 = await JourneyFactory.createJourney(id, {"city": "TORRONTO","adress": "1 rue Torronto"}, {"city": "MontReal","adress": "10 Rue St-Pierre"}, "2025-06-12T20:52:39.890Z", {"total": 5,"left": 3}, 40, car._id)
        await j1.save()

        // La second est passée
        j2 = await JourneyFactory.createJourney(id, {"city": "Montreal","adress": "1 rue Torronto"}, {"city": "TorronTo","adress": "10 Rue St-Pierre"}, "2025-04-12T20:52:39.890Z", {"total": 5,"left": 3}, 40, car._id)
        await j2.save()
    });
